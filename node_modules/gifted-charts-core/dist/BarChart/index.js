...
export var useBarChart = function (props) {
    ...
    var _79 = __read(useState(''), 2), points = _79[0], setPoints = _79[1];
    var _80 = __read(useState(''), 2), points2 = _80[0], setPoints2 = _80[1];
    var _81 = __read(useState(''), 2), arrowPoints = _81[0], setArrowPoints = _81[1];
    var _82 = __read(useState(function () {
    ...
    }), 2), selectedIndex = _82[0], setSelectedIndex = _82[1];
    var _83 = __read(useState((_b = props.highlightedStackIndex) !== null && _b !== void 0 ? _b : -1), 2), selectedStackIndex = _83[0], setSelectedStackIndex = _83[1];
    ...
    var _84 = __read(useState((_0 = (_z = props.lineConfig) === null || _z === void 0 ? void 0 : _z.focusedDataPointIndex) !== null && _0 !== void 0 ? _0 : -1), 2), focusedDataPointIndex = _84[0], setFocusedDataPointIndex = _84[1];
    var _85 = __read(useState((_2 = (_1 = props.lineConfig2) === null || _1 === void 0 ? void 0 : _1.focusedDataPointIndex) !== null && _2 !== void 0 ? _2 : -1), 2), focusedDataPointIndex2 = _85[0], setFocusedDataPointIndex2 = _85[1];
    ...
    var _86 = axesAndRulesProps.secondaryYAxisConfig, secondaryStepHeight = _86.stepHeight, secondaryStepValue = _86.stepValue, secondaryNegativeStepHeight = _86.negativeStepHeight, secondaryNegativeStepValue = _86.negativeStepValue, secondaryNoOfSectionsBelowXAxis = _86.noOfSectionsBelowXAxis;
    ...
    var _87 = __read(useState(-1), 2), pointerIndex = _87[0], setPointerIndex = _87[1];
    var _88 = __read(useState(0), 2), pointerX = _88[0], setPointerX = _88[1];
    var _89 = __read(useState(0), 2), pointerY = _89[0], setPointerY = _89[1];
    var _90 = __read(useState(), 2), pointerItem = _90[0], setPointerItem = _90[1];
    var _91 = __read(useState(0), 2), responderStartTime = _91[0], setResponderStartTime = _91[1];
    var _92 = __read(useState(false), 2), responderActive = _92[0], setResponderActive = _92[1];
